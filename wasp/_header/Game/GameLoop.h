...
namespace wasp::game {
	...
	public:
		GameLoop(
			...
			: running { false }, updatesPerSecond { updatesPerSecond }, maxUpdatesWithoutFrame {
			maxUpdatesWithoutFrame
		}, updateFunction { updateFunction }, renderFunction { renderFunction } {
		};
